...
Model.prototype.warn = function(){
  this.output.warn.apply(this.output, arguments);
};

Model.prototype.log = function(string){
  this.output.log.apply(this.output, arguments);
};

Model.prototype.win = function(string){
  this.output.win.apply(this.output, arguments);
};

Model.prototype.in = function(string, options){
  this.output.in.apply(this.output, arguments);
};
