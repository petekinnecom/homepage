...
var $ = require('jquery');
var Router = require('app/router/hashchange/router');
...
var MobileController = require('app/mobile/controller');
...
var Menu = require('app/menu/commander');
...
$(function(){
  ...
  var router = new Router({
    ...
    root: {id: 'welcome', controller: 'pages'}
  });

  var mobileController = new MobileController($(notificationClass));
  ...
  new TerminalController($terminal, mobileController);
